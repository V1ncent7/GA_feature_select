...
if __name__ == '__main__':
    ...
    SAVE_FREQ = 5
    '''
    DATA_FILE_NAME = './data2/acfgSSL_{}/'.format(NODE_FEATURE_DIM)
    ...
    if os.path.isfile('data2/test.json'):
        with open('data2/test.json') as inf:
        ...
        with open('data2/test.json', 'w') as outf:
